...
////focus on particular kinds of data 
...
////filtering the data to just 2017 
...
Promise.all([dataPromise, metadataPromise, geojsonPromise])
	.then(function([data, metadata, geojson]){
		...
		////filtering data to what I really want 
		////this happens once
		...
		////lets us pick which year, update
...
function parseData(d){
	...
	const series = d['Series Name']; //// using this
